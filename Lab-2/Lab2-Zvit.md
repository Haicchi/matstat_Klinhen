...
Лабораторна робота №1 . Основи роботи з Git. Налаштування Git-GitHub
середовища

Author - Kyrylo Klingen

Мета : швидкий старт для роботи із системою контроля версій (СКВ) Git та
віддаленим репозиторієм GitHub.

1 . Створити аккаунт на GitHub і налаштувати доступ до нього (за SSH,
або https протоколом).
...
![](Lab2-Zvit_files/figure-gfm/unnamed-chunk-1-1.svg)<!-- -->
...
![](Lab2-Zvit_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](Lab2-Zvit_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
